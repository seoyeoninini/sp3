...
<div class="container">
	...
	<div class="main-header">
		...
		<p> 여러개 마커 및 이벤트 등록 : 마커에 click 이벤트를 등록 </p>
	</div>
...
<script type="text/javascript">
	...
	function createMarker(data) {
		...
		$(data.list).each(function(index, item){
			let mobj = {
					content:"<div class='marker-info' data-num='"+item.num+"'>"+item.subject+"</div>",
		...
		for (var i = 0; i < positions.length; i ++) {
		    ...
		    // mouseover / mouseout 마커에 표시할 인포윈도우를 생성
		...
		// click시 인포 윈도우를 표시하는 클로저를 만드는 함수
